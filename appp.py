...
st.markdown("""
    <style>
        ...
        h1, h2, h3, .markdown-text-container, .stMarkdown {
...
# Stylized title
st.markdown("""
    <div style='text-align: center; font-size: 36px; font-weight: bold; color: #004d40; margin-top: 20px;'>
...
# Welcome subtitle
st.markdown("""
    <div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: #004d40;'>
...
# Instruction
st.markdown("""
    <div style='text-align: left; font-size: 22px; padding-top: 10px; color: #004d40;'>
...
ax.set_title(f"Cumulative EV Trend - {county} (3 Years Forecast)", fontsize=14, color='#004d40')
ax.set_xlabel("Date", color='#004d40')
ax.set_ylabel("Cumulative EV Count", color='#004d40')
ax.grid(True, alpha=0.3)
ax.set_facecolor("#ffffff")
fig.patch.set_facecolor('#ffffff')
ax.tick_params(colors='#004d40')
ax.legend()
st.pyplot(fig)
...
if multi_counties:
    ...
    ax.set_title("EV Adoption Trends: Historical + 3-Year Forecast", fontsize=16, color='#004d40')
    ax.set_xlabel("Date", color='#004d40')
    ax.set_ylabel("Cumulative EV Count", color='#004d40')
    ax.grid(True, alpha=0.3)
    ax.set_facecolor("#ffffff")
